namespace _03.SumOfFileSizesInTree
{
    using System;
    using System.IO;
    ...
    and using them build a tree keeping 
    all files and folders on the hard drive starting from C:\WINDOWS. 
    ...
    */
    public class CalculateFileSizesSum
    {
        private static void Main()
        {
            string path = "../../"; //// Project Folder Directory
